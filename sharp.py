...
TELEGRAM_BOT_TOKEN = '7342907950:AAGeZxiIVvHkkBLRaJn0fwjyZyrhd_Cj5Oc'
...
async def start(update: Update, context: CallbackContext):
    ...
    message = (
        "*🔥 Welcome to the SMOKIE DDOS PUBLIC🔥*\n\n"
...
async def run_attack(chat_id, ip, port, duration, context):
    ...
    try:
        ...
        attack_in_progress = False
        await context.bot.send_message(chat_id=chat_id, text="*✅ Attack Completed! ✅*\n*Thank you for using our SMOKIE DDOS PUBLIC!*", parse_mode='Markdown')
...
async def attack(update: Update, context: CallbackContext):
    ...
    if user_id not in users:
        await context.bot.send_message(chat_id=chat_id, text="*⚠️ Amit Se Gaand Marwa Jaake.*", parse_mode='Markdown')
        return
